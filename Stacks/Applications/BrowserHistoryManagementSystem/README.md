...
This is a simple **Browser History Management System** created using Stacks.

## Main Features

The main features of the System is:

- Visiting a Page Using URL
...
```text
javac Applications/BrowserHistoryManagementSystem/BrowserHistoryApp.java
```
...
```text
java Applications.BrowserHistoryManagementSystem.BrowserHistoryApp
```
